...
public abstract class AdminUser implements User {
	...
	AdminUser(String username, String password, Integer studentCardId, int userTypeId, String email) {
	...
	AdminUser(Long userId, Long studentCardId, Long userTypeId,  String username, String password, String email, boolean isBanned) {
